...
export const adminNavGroups: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/admin/shipping",
        label: "Pengiriman",
        description: "Kirim, pickup, dan resi",
        icon: Truck,
    ...
    items: [
      {
        ...
        label: "Ekspedisi",
        description: "Kurir dan layanan aktif",
        icon: Boxes,
      ...
      },
      {
        ...
        href: "/admin/check",
        label: "Cek WA & Ongkir",
        description: "Riwayat pembeli dan tarif",
        icon: ClipboardCheck,
    ...
    items: [
      {
        ...
        description: "Sinyal konversi iklan",
        icon: Megaphone,
    ...
    items: [
      {
        ...
        label: "Pembayaran",
        shortLabel: "Payment",
        description: "Metode dan rekonsiliasi",
        icon: CreditCard,
      ...
      },
      {
        ...
        href: "/admin/settings",
        label: "Pengaturan",
        description: "Toko, gudang, dan akses",
        icon: Settings,
