...
import { generateMetaCatalogXml } from "../../lib/catalog-feed";
...
export const GET: APIRoute = async ({ locals }) => {
  ...
  try {
    ...
    const xml = generateMetaCatalogXml(products, origin, siteTitle, siteDescription);
    ...
    console.error("meta-catalog-xml-error", error);
    return new Response(
