...
> Last executed baseline: 2026-08-27 @ `3bb51a3` + payment-recovery working tree.
> `npm run check` 396 files / 0 errors / 0 warnings / 0 hints · `npm test`
> 583 / 583 · `npm run build` Cloudflare server bundle complete · local
...
| Version | `1.3.3` / `2026.08-payment-recovery` (`src/lib/version.ts`) |
