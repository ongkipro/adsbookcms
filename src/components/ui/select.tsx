 ...
 return (
  <SelectPrimitive.Trigger
   ...
   className={cn(
    ...
    size === "default" && !(typeof className === 'string' && className.includes("h-")) ? "h-10" : "",
    size === "sm" && !(typeof className === 'string' && className.includes("h-")) ? "h-8" : "",
    className
   )}
   {...props}
  >
   {children}
   {/* Base UI's Icon defaults its children to a "▼" text node, which the
       render prop placed inside the SVG: invisible, but copied with the text. */}
